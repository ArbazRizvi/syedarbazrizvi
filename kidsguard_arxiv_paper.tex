...
\begin{figure}[H]
    ...
    % \framebox{...} code has been DELETED
    
    % This is the NEW, correct line that includes your image:
    \includegraphics[width=0.8\textwidth]{tracking_rmse_comparison.png} 
    ...
    the Kalman Filter-enhanced pipeline.} [cite: 48]
    \label{fig:tracking_comparison} [cite: 48]
\end{figure}
